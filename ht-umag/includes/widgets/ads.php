...
class ht_ads extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			'classname'     => 'ht_ads',
			'description'   => __( 'Displays 6 125x125 ads blocks', 'highthemes' ),
			'panels_groups' => array( 'highthemes' )
		);
		parent::__construct(
			'ht_ads',
			'Highthemes - ' . __( 'Custom Ads 125x125', 'highthemes' ),
			$widget_ops // Args
		);
	}
	...
	function widget( $args, $instance ) {
        ...
        echo '<div class="ad-125x125"><div class="row">';
		...
		//Display ads
		foreach($ads as $ad){
			echo '<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">' . $ad . '</div>';
		}
	...
	function form( $instance ) {
		...
		$defaults = array(
		'title' => 'Advertisement',
		'ad1' => get_template_directory_uri()."/images/ads3.jpg",
		'link1' => 'http://www.highthemes.com',
		'ad2' => get_template_directory_uri()."/images/ads3.jpg",
